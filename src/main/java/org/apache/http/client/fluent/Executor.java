...
public class Executor {
    ...
    static {
        ...
        try {
            ssl = new SSLSocketFactory(new TrustStrategy() {
                @Override
                public boolean isTrusted(final X509Certificate[] x509Certificates, final String s) throws java.security.cert.CertificateException {
                    return true;
                }
